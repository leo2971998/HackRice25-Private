      ...
      <div className="max-w-7xl mx-auto space-y-6">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div className="text-right">
                <div className="text-sm font-medium text-gray-900">{customers.length} Customers</div>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  <select 
                    ...
                    className="w-full rounded-lg border-2 border-gray-200 px-3 py-3 text-sm focus:border-blue-500 focus:outline-none"
                  >
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full rounded-lg border-2 border-gray-200 px-3 py-2 text-sm focus:border-emerald-500 focus:outline-none"
                    />
                  </div>
                  <div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full rounded-lg border-2 border-gray-200 px-3 py-2 text-sm focus:border-red-500 focus:outline-none"
                    />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">Description</label>
        ...
        {showAdvanced && (
          <div className="bg-white rounded-2xl shadow-xl p-6">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <h4 className="font-medium text-gray-700 mb-2">Customer Form Data</h4>
                <pre className="text-xs bg-gray-50 p-3 rounded-lg overflow-auto max-h-32 border">
                  {JSON.stringify(custForm, null, 2)}
                </pre>
              </div>
              <div>
                <h4 className="font-medium text-gray-700 mb-2">Account Form Data</h4>
                <pre className="text-xs bg-gray-50 p-3 rounded-lg overflow-auto max-h-32 border">
                  {JSON.stringify(acctForm, null, 2)}
                </pre>
              </div>
              <div>
                <h4 className="font-medium text-gray-700 mb-2">Deposit Form Data</h4>
                <pre className="text-xs bg-gray-50 p-3 rounded-lg overflow-auto max-h-32 border">
                  {JSON.stringify(depForm, null, 2)}
                </pre>
              </div>
              <div>
                <h4 className="font-medium text-gray-700 mb-2">Purchase Form Data</h4>
                <pre className="text-xs bg-gray-50 p-3 rounded-lg overflow-auto max-h-32 border">
