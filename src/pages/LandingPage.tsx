    ...
    <div className="min-h-screen">
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-24">
        <section className="text-center space-y-6">
          ...
          <p className="text-xl text-dark-900 max-w-3xl mx-auto">
          ...
          <Card className="p-10 bg-dark-200/50 border border-dark-400/60 backdrop-blur">
            <div className="flex items-center space-x-4 mb-6">
              ...
              <div>
                ...
                <p className="text-dark-900">Three simple steps to quantify and beat personal inflation.</p>
              </div>
            </div>
            <ol className="space-y-6 text-left">
              <li className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-dark-900">Use the trusted Plaid Link flow to add cards and banks from hundreds of institutions in minutes.</p>
                </div>
              </li>
              <li className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-dark-900">We send transaction descriptions to Gemini with a constrained taxonomy so each purchase lands in the right CPI bucket.</p>
                </div>
              </li>
              <li className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-dark-900">Watch your personalised inflation dashboard update instantly and chat with the assistant for tailored strategies.</p>
                </div>
              </li>
            </ol>
          </Card>
          ...
          <Card className="p-10 bg-dark-200/30 border border-dark-400/60 backdrop-blur">
            <div className="flex items-center space-x-4 mb-6">
              ...
              <div>
                ...
                <p className="text-dark-900">Multimodal uploads powered by Gemini</p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="bg-dark-300/60 border border-dark-400/50 rounded-xl p-4">
                ...
                <p className="text-dark-900 text-sm">Gemini Vision reads totals, dates, and merchants in seconds—no manual data entry required.</p>
              </div>
              <div className="bg-dark-300/60 border border-dark-400/50 rounded-xl p-4">
                <h4 className="text-white font-semibold mb-2">Instant categorisation</h4>
                <p className="text-dark-900 text-sm">Receipts flow straight into the same CPI-aligned model driving your personal inflation insights.</p>
              </div>
            </div>
          </Card>
        </section>
        ...
        <section className="grid md:grid-cols-3 gap-8">
          <Card hoverable>
            <CardContent className="p-8 space-y-3">
              ...
              <p className="text-dark-900">Every widget ties into CPI data and real spending so hackathon judges see a credible, production-ready path.</p>
            </CardContent>
          </Card>
          <Card hoverable>
            <CardContent className="p-8 space-y-3">
              ...
              <p className="text-dark-900">Gemini dynamically requests personal inflation snapshots before responding, ensuring advice is grounded in live numbers.</p>
            </CardContent>
          </Card>
          <Card hoverable>
            <CardContent className="p-8 space-y-3">
              ...
              <p className="text-dark-900">A cinematic UI, dark neon gradients, and motion states highlight complex analysis in a glanceable way.</p>
            </CardContent>
          </Card>
        </section>
